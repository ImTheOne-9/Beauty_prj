    ...
    <section className="bg-white py-16 text-slate-900">
      ...
      <div className="mx-auto max-w-[1400px] px-8 grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
        ...
        <div className="space-y-6">
          <h3 className="font-display text-xl font-bold tracking-tight sm:text-2xl text-slate-900">
          ...
          <ul className="space-y-4">
            {items.map((item, idx) => (
              <li key={idx} className="flex items-start gap-3">
                <span className="flex-shrink-0 mt-0.5 rounded-full border border-rose-200 bg-rose-50 p-1 text-rose-500">
